package com.mss.arrivalfiletransfer.chipsViewHelper.views;
...
import com.mss.arrivalfiletransfer.chipsViewHelper.util.ColorUtil;
import com.mss.arrivalfiletransfer.chipsViewHelper.util.LetterTileProvider;
...
public class DetailedChipView extends RelativeLayout {
    ...
    @Bind(R.id.avatar_icon) CircleImageView mAvatarIconImageView;
    @Bind(R.id.name) TextView mNameTextView;
    @Bind(R.id.info) TextView mInfoTextView;
