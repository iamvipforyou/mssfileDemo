...
import com.mss.arrivalfiletransfer.Utils.ToastUtil;
import com.mss.arrivalfiletransfer.activity.AllFilesPicker;
import com.mss.arrivalfiletransfer.activity.ImageBrowserActivity;
import com.mss.arrivalfiletransfer.activity.ImagePickActivity;
        ...
        if (isNeedCamera && position == 0) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putParcelableArrayListExtra(IMAGE_BROWSER_SELECTED_LIST, ((AllFilesPicker) mContext).mSelectedList);
